...
- **Два новых приёмочных сценария красные, причина не установлена.** В набор
  добавлены проверки TC-09 и TC-10 (отказ для двоичного файла, диалог при
  закрытии, Ctrl+F). На последнем прогоне они упали, но прогон шёл на
  бинарнике, собранном до последних правок интерфейса и закрытия окна.
  Скорее всего, нужна пересборка и повторная проверка, а не починка кода —
