...
- [x] Файл удалён снаружи помечается в окне; следующее обычное сохранение
      воссоздаёт файл. Поведение при переименовании требует отдельной приёмки
...
Осталось: отдельно принять сценарий переименования и повторить приёмку
окон/закрытия без параллельных запусков.
