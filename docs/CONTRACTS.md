...
- открытие файла из проводника по-прежнему открывает **новое окно**. Это не
  трогаем;
...
- автосохранять неактивные вкладки по таймеру активной. Таймер принадлежит
  вкладке, а не окну;
- показывать вкладки, когда она одна. Полоса появляется со второй вкладки:
  редактор на один файл должен остаться таким же простым, как был.
