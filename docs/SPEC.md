...
зашита намеренно. Окно настроек есть, но узкое: в нём живёт только то, на что
у разумных людей разные ответы — язык интерфейса, проверка орфографии,
масштаб, ширина колонки, поведение автосохранения. Состав описан в
[SETTINGS.md](SETTINGS.md). Того, что составляет принцип программы —
одна тёмная тема, одно окно на файл, отсутствие плагинов и хранилищ, —
в настройках нет и не будет.
