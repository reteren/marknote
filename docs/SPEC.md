...
стартовым экраном; полоса вкладок появляется со второй вкладки. Хранилищ и
боковой панели нет.
...
Полоса вкладок (`TabBar`) отображается только со второй вкладки. Подпись
...
а справа — кнопка «+». Когда вкладка одна, «+» остаётся рядом с элементами
сохранения; при добавлении второй вкладки он переезжает в полосу. Новая вкладка
всегда начинается со стартового экрана, где можно выбрать формат или открыть
файл. Сочетание `Ctrl+T` делает то же самое.

Открытие файла из Проводника по-прежнему направляется в новое окно. Это правило
не меняется из-за наличия вкладок внутри уже открытого окна.
...
- Вкладки живут внутри одного окна: полоса появляется со второй вкладки, а
  открытие файла из Проводника создаёт новое окно. Закрытие вкладки с изменениями
